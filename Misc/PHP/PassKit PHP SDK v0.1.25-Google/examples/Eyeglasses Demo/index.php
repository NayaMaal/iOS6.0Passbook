...
$pass_description = "This pass demonstrates how the PassKit API can be used to provide passes for small and independent businesses and professional practices.</p><p>This page was built using the <a href='http://code.google.com/p/passkit/downloads/detail?name=PassKit%20PHP%20SDK%20v0.1.25.zip' title='PassKit PHP SDK'>PassKit SDK</a>. You can access the source code for this page <a href='http://code.google.com/p/passkit/source/browse/trunk/PHP/examples/Eyeglasses%20Demo/index.php' title='PassKit PHP SDK Source'>here</a>.";
...
<link rel="stylesheet"
	href="https://ajax.aspnetcdn.com/ajax/jquery.mobile/1.1.1/jquery.mobile-1.1.1.min.css" />
<link href="https://d321ofrgjjwiwz.cloudfront.net/samples/iphone.css"
...
<body>
	<div data-role="page" id="newpass">
		...
		<div data-role="content">
			<div class="ui-listview ui-listview-inset ui-corner-all ui-shadow"
				style="padding: 8px 15px; margin-top: 0;">
				<div class="iconImage">
					<img src="<?php echo $pass_image; ?>"
						alt="<?php echo $pass_name; ?>" />
				</div>
			...
			<div class="ui-listview ui-listview-inset ui-corner-all ui-shadow"
				...
				echo $pass_error ? '<span style="background:#f00;color:#fff;font-weight:bold;">&nbsp;Error:&nbsp;</span>&nbsp;' . $pass_error : 'Please enter your details below to create your pass';
				?></p>
				<div class="clear"></div>
			</div>
			<div class="formBody">
				<form id="passForm" name="passForm" data-ajax="false"
					action="https://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>"
	...
	<input id="lat" type="hidden" name="iLat" value="" /> <input id="long"
						type="hidden" name="iLng" value="" /> <input id="locd"
						type="hidden" name="iLoc" value="1" disabled="disabled" />
				</form>
			</div>
		</div>
		<div data-role="footer" data-theme="b" data-position="fixed"
			data-tap-toggle="false" data-id="pkf">
			<h6>
				<a href="http://passkit.com" title="Create Passbook Passes"
					rel="external" target="_blank"><img
					src="https://d321ofrgjjwiwz.cloudfront.net/images/passkit_icon.svgz"
					alt="Create Passbook Passes" /> Created with PassKit</a>
			</h6>
		</div>
	</div>
